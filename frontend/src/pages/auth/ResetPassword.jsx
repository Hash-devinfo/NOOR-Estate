...
const ResetPassword = () => {
  ...
  // to submit the nwe password

  const handleSubmit = async (e) => {
    e.preventDefault();
    if (password !== confirmPassword) {
      return setError("Passsword do not matched");
    }
    setIsLoading(true);
    setError("");
    setSuccess("");
    ...
    try {
      ...
      if (res.data.success) {
        setSuccess(
          "Password has been reset successfuly! Redirecting to login...",
        );
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  placeholder="Type Confrim New Password"
                  required
                  className={s.input}
                  style={{ paddingRight: "40px" }}
                />
