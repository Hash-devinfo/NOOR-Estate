...
const AddProperty = () => {
  ...
  //  to handle submission form property
      ...
      <div className={s.innerContainer}>
        ...
        <form onSubmit={handleSubmit} className={s.form}>
            ...
            <div className={s.contentGroupLarge}>
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Luxury 3BHK Apartment in DHA Islamabad."
                  className={s.input}
                  required
                />
              </div>
          ...
          <div className={s.twoColumnGrid}>
            ...
            <div>
              ...
              <div className={s.contentGroupSmall}>
                <div>
                  <label className={s.labelSmallMargin}>Price (Rs.)</label>
                  <input
                    type="number"
                    name="price"
          ...
          <div className={s.section}>
            ...
            <h4 className={s.uploadTitle}>Click to upload or drag and drop</h4>
            ...
            <div className={s.previewsGrid}>
                {imagePreviews.map((src, i)=>(
                    <div key={i} className={s.previewItem}>
                        ...
                        <button onClick={()=> removeImages(i)} 
                            className={s.removeButton} style={{ transform: "rotate(45deg)" }} 
                            > <HiUpload size={12}/></button>
                    </div>
                ))}
          ...
          <div className={s.footerButtons}>
            ...
            <button type="aubmit" className={s.submitButton}
            disabled={loading}>
